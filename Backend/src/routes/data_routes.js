...
function extractToken(req) {
  ...
  //Den kortsluter: om den vänstra operanden är false returneras den vänstra operanden, annars returneras den högra operanden.
  ...
  //Om authHeader är false (null, undefined eller en tom sträng) kommer token att tilldelas värdet för authHeader.
  //Om authHeader är en icke-tom sträng (truth) kommer token att tilldelas den extraherade token från authHeader.
