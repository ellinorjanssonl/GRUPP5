//fs används för att läsa och skriva till filer och promises används för att hantera asynkrona funktioner
const fs = require('fs').promises;
//importerar express som används för att skapa en router
...
//importerar dotenv för att kunna använda .env filen i projektet och hämta secret key
...
//fubktion för att hämta användarens roll baserat på e-postadressen
